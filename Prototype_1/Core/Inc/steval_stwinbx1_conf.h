...
#ifndef STEVAL_STWINBX1_CONF_H
#define STEVAL_STWINBX1_CONF_H
...
/** @defgroup STEVAL_STWINBX1_CONFIG Config
  * @{
  */

/** @defgroup STEVAL_STWINBX1_CONFIG_Exported_Constants
  * @{
  */
/* COM Feature define */
